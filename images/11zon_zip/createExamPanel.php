...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <script>
        ...
        function saveExamPanel() {
            ...
            const panels = Array.from(rows).map(row => {
                const ac_id = row.querySelector('select[name="first_examiner"]').getAttribute('data-ac-id');
                const first_examiner = row.querySelector('select[name="first_examiner"]').value;
                const second_examiner = row.querySelector('select[name="second_examiner"]').value;
                const third_examiner = row.querySelector('select[name="third_examiner"]').value;
                const fourth_examiner = row.querySelector('select[name="fourth_examiner"]').value; // পরিবর্তিত অংশ
